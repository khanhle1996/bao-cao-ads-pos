...
DEFAULT_WORKSPACE = Path(os.getenv("WORK_REPORT_WORKSPACE", "/Users/thienlong/Desktop/Test Antigravity"))
FB_ENV_PATH = Path(os.getenv("WORK_REPORT_FB_ENV_PATH", str(DEFAULT_WORKSPACE / "Facebook Ads Bot" / ".env")))
POS_ENV_PATH = Path(os.getenv("WORK_REPORT_POS_ENV_PATH", str(DEFAULT_WORKSPACE / "Kết nối POS Pancake" / ".env")))
BRANDS_PATH = Path(os.getenv("WORK_REPORT_BRANDS_PATH", str(ROOT / "config" / "brands.json")))
STATE_PATH = Path(os.getenv("WORK_REPORT_STATE_PATH", str(ROOT / "data" / "report_runs.sqlite3")))
